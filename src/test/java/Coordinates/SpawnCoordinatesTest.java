...
import static Simulation.Coordinates.SpawnCoordinates.*;
...
class SpawnCoordinatesTest {
    ...
    void listSize() {
        ...
        List<Vector2> myPoints = fixedSpawnPoints(1,new Vector2(1,1),1,new Vector2(0,0),occupiedPositions);
    ...
    void maksNumberOfAvailablePoints() {
        ...
        List<Vector2> myPoints1 = fixedSpawnPoints(10,new Vector2(1,1),1,new Vector2(0,0),occupiedPositions);

        List<Vector2> myPoints2 = fixedSpawnPoints(20,new Vector2(1,1),1,new Vector2(0,0),occupiedPositions);
        assertTrue(myPoints1.size() == myPoints2.size());
    }

    @ParameterizedTest
    @MethodSource("spawnData")
    void correctPoints(Vector2 boundSquare, float distanceBetweenPoints, List<Vector2> occupiedPositions, List<Vector2> expectedPoints) {
        List<Vector2> myPoints = fixedSpawnPoints(100,boundSquare,distanceBetweenPoints,new Vector2(0,0),occupiedPositions);
    ...
    private static List<Object[]> spawnData() {
        return Arrays.asList(
                ...
                new Object[]{new Vector2(1,1),1.5f,
                        new ArrayList<>(),
                        Arrays.asList(
                                new Vector2(-1, -1),
                                new Vector2(0.5f, -1),
